...
dodgers_vs_giants <- baseball_game(giants, dodgers)
```
...
Here is a plot of the resulting win probabilities, where the blue color is the Dodgers, and the orange color is the Giants.
```{r echo=TRUE}
ggplot(dodgers_vs_giants, aes(x = batters_faced)) + geom_line(aes(y=home), color = 'darkorange', lwd = 1.2) + geom_line(aes(y=away), color = 'dodgerblue3', lwd = 1.2) + scale_x_continuous(n.breaks = 9) + xlab("Total Batters Faced") + ylab("Win Percentage")
```
